...
var file_cmd_cmd_dungeon_proto_goTypes = []any{
...
func file_cmd_cmd_dungeon_proto_init() {
	...
	file_cmd_cmd_dungeon_proto_msgTypes[20].OneofWrappers = []any{
	...
	file_cmd_cmd_dungeon_proto_msgTypes[21].OneofWrappers = []any{
		(*DungeonPlayerDieNotify_MonsterId)(nil),
		(*DungeonPlayerDieNotify_GadgetId)(nil),
	}
	file_cmd_cmd_dungeon_proto_msgTypes[31].OneofWrappers = []any{
