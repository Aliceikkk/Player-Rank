...
var file_cmd_cmd_gallery_proto_goTypes = []any{
...
func file_cmd_cmd_gallery_proto_init() {
	...
	file_cmd_cmd_gallery_proto_msgTypes[1].OneofWrappers = []any{
		(*GalleryStartNotify_FlowerStartParam)(nil),
	}
	file_cmd_cmd_gallery_proto_msgTypes[45].OneofWrappers = []any{
	...
	file_cmd_cmd_gallery_proto_msgTypes[85].OneofWrappers = []any{
