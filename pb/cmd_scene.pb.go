...
var file_cmd_cmd_scene_proto_goTypes = []any{
...
func file_cmd_cmd_scene_proto_init() {
	...
	file_cmd_cmd_scene_proto_msgTypes[93].OneofWrappers = []any{
		(*WorldPlayerDieNotify_MonsterId)(nil),
		(*WorldPlayerDieNotify_GadgetId)(nil),
	}
	file_cmd_cmd_scene_proto_msgTypes[122].OneofWrappers = []any{
		(*ChatInfo_Text)(nil),
		(*ChatInfo_Icon)(nil),
		(*ChatInfo_SystemHint_)(nil),
	}
	file_cmd_cmd_scene_proto_msgTypes[146].OneofWrappers = []any{
