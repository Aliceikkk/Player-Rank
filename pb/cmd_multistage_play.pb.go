...
var file_cmd_cmd_multistage_play_proto_goTypes = []any{
...
func file_cmd_cmd_multistage_play_proto_init() {
	...
	file_cmd_cmd_multistage_play_proto_msgTypes[11].OneofWrappers = []any{
	...
	file_cmd_cmd_multistage_play_proto_msgTypes[28].OneofWrappers = []any{
	...
	file_cmd_cmd_multistage_play_proto_msgTypes[35].OneofWrappers = []any{
