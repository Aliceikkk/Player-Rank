...
var file_cmd_cmd_player_proto_goTypes = []any{
...
func file_cmd_cmd_player_proto_init() {
	...
	file_cmd_cmd_player_proto_msgTypes[89].OneofWrappers = []any{
	...
	file_cmd_cmd_player_proto_msgTypes[94].OneofWrappers = []any{
