...
var file_server_only_redis_data_proto_goTypes = []any{
...
func file_server_only_redis_data_proto_init() {
	...
	file_server_only_redis_data_proto_msgTypes[25].OneofWrappers = []any{
		(*ChatRedisData_Text)(nil),
		(*ChatRedisData_Icon)(nil),
		(*ChatRedisData_SystemHint_)(nil),
	}
	file_server_only_redis_data_proto_msgTypes[26].OneofWrappers = []any{
		(*ChatMixRedisData_Text)(nil),
		(*ChatMixRedisData_Icon)(nil),
		(*ChatMixRedisData_SystemHint_)(nil),
	}
	file_server_only_redis_data_proto_msgTypes[31].OneofWrappers = []any{
		(*ActivitySocialData_BlessingData)(nil),
		(*ActivitySocialData_PlantFlowerData)(nil),
		(*ActivitySocialData_WinterCampData)(nil),
	}
	file_server_only_redis_data_proto_msgTypes[50].OneofWrappers = []any{
		(*UgcRedisData_MusicContent)(nil),
	}
	file_server_only_redis_data_proto_msgTypes[54].OneofWrappers = []any{
